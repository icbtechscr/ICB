...
function CostaRicaFlag({
  ...
  return (
    <span
      aria-hidden="true"
      className={`inline-flex shrink-0 flex-col overflow-hidden rounded-[2px] shadow-sm ring-1 ring-black/10 ${className ?? ""}`}
...
export function PatrioticMonthBar() {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, rgba(0,43,127,0.10) 0%, rgba(255,255,255,0.96) 35%, rgba(255,255,255,0.96) 65%, rgba(206,17,38,0.10) 100%)",
      }}
    >
      <div className="mx-auto flex max-w-7xl items-center justify-center gap-2.5 px-3 py-1.5 sm:px-4">
        <CostaRicaFlag width={22} style={{ transform: "rotate(-5deg)" }} />
...
export function PatrioticMonthPageDecor() {
  const soft = "opacity-[0.18] dark:opacity-[0.12]";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(105deg, rgba(0,43,127,0.08) 0%, rgba(0,43,127,0) 40%, rgba(206,17,38,0) 62%, rgba(206,17,38,0.08) 100%)",
        }}
      />

      <CostaRicaFlag
        width={78}
        className="absolute -left-5 -top-4 opacity-30 dark:opacity-20"
        style={{ transform: "rotate(-13deg)" }}
      />
      <CostaRicaFlag
        width={46}
        className="absolute left-16 top-8 hidden opacity-25 sm:inline-flex dark:opacity-15"
        style={{ transform: "rotate(7deg)" }}
      />
      <CostaRicaFlag
        width={88}
        className="absolute -bottom-5 -right-6 opacity-25 dark:opacity-15"
        style={{ transform: "rotate(12deg)" }}
      />
      <CostaRicaFlag
        width={48}
        className="absolute bottom-8 right-20 hidden opacity-25 sm:inline-flex dark:opacity-15"
        style={{ transform: "rotate(-7deg)" }}
      />
