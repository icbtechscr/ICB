  ...
  return (
    ...
    >
      ...
      <LegalSection heading="3. Pedidos">
        <p>
          Un pedido se considera confirmado una vez verificado el pago. ICB
          Technologies puede rechazar o cancelar pedidos por falta de stock,
          errores de información o sospecha de fraude, con la devolución
          correspondiente del monto pagado.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="5. Propiedad intelectual">
        <p>
          Las marcas, logotipos y contenidos del sitio pertenecen a ICB
          Technologies o a sus respectivos titulares. No se permite su uso sin
          autorización.
        </p>
      </LegalSection>
